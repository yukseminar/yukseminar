	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <h4 class="m-0" style="font-weight: 600;"><b>Daftar Peserta yang Telah Hadir</b></h4>
                </div>
              </div>
	    ...
	    $.ajax({
	      ...
	      success: function(result) {
	        ...
	        $.each(objResult, function(key, val){
	          var barisBaru = $("<tr>");
	          console.log(val);
	          setTimeout(readAllPesertaHadir(), 1000);
	          if(val.hadir == 1){
	          	barisBaru.html("<td>"+nomor+"</td><td><img class='photo_peserta' src='"+base_url+"assets/"+val.photo_user+"'></td><td>"+val.nim_user+"</td><td>"+val.nama_user+"</td><td>"+val.universitas+"</td><td>"+val.jurusan+"</td><td><span class='badge badge-primary'>Sudah Hadir</span></td>");
	          }else{
	          	barisBaru.html("");
	          }
