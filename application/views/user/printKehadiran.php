...
<div class="container">
  ...
  <div class="row mt-3 mb-3">
    <div class="col-lg-12">
      <h2 class="text-center"><b>Absensi Kehadiran Peserta <?= $dataseminar['nama_seminar'] ?></b></h2>
    </div>
  </div>
...
<div class="row">
  <h5 style="color: rgba(0, 200, 81, 1)">Catatan : Data absensi berasal dari sistem Yukseminar.id</h5>
</div>
