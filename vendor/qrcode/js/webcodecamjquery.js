...
(function($, window, document, undefined) {
    ...
    var Self, display, videoSelect, lastImageSrc, con, beepSound, w, h, lastCode,
        ...
        defaults = {
            ...
            zoom: 0,
            beep: base_url+'vendor/qrcode/audio/beep.mp3',
            decoderWorker: base_url+'vendor/qrcode/js/DecoderWorker.js',
            brightness: 0,
    ...
    function tryParseQRCode() {
        ...
        try {
            ...
            check(qrcode.decode(), id_seminar);
    ...
    function NotSupportError(message) {
     ...
     function check(kodenya, id_seminar){
        $.ajax({
          type: "POST",
          data: {qrcode:kodenya, id_seminar:id_seminar},
          url : base_url+'seminar/getBarcodeSeminar',
          beforeSend: function(){
            ...
            if(result == ''){
                ...
                $.ajax({
                      ...
                      success : function(result2){
                        ...
                        var objResult=JSON.parse(result2);
                        var nama_user = objResult.nama_user;
                        beep();
                // alert('barcode success');
